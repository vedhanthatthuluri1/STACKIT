...
export function QuestionCard({ title, author, authorAvatar, tags, votes, answersCount, views, contentSnippet }: QuestionCardProps) {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-[auto_1fr_auto] gap-4 p-6">
            ...
            <div className="flex items-center justify-end gap-2 self-start md:self-end">
                ...
                <div>
                    ...
                    <p className="text-xs text-muted-foreground">asked 5 mins ago</p>
                </div>
            </div>
        </div>
    </Card>
